...
function PiholeRegexGenerator() {
  ...
  return (
    <>
      <MetaTags
        title="Pi-hole Regex Generator"
        description="Generate effective regex patterns for Pi-hole DNS filtering. Create and test custom regex rules to block unwanted domains and enhance your network security."
        keywords={[
          'pihole regex generator',
          'pi-hole regex',
          'dns filtering',
          'domain blocking',
          'regex patterns',
        ...
        canonicalUrl="/pihole-regex-generator"
      />
