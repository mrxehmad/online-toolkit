  ...
  return (
    <>
      <MetaTags
        ...
        description="Plan your financial future with our comprehensive investment calculator. Calculate returns, compound interest, and growth projections for your investments."
        keywords={[
