  ...
  return (
    <>
      <MetaTags
        ...
        description="Create and understand crontab scheduling expressions with our user-friendly online tool. Features include preset schedules, human-readable descriptions, and next execution time preview."
        keywords={[
          'crontab',
          'cron expression',
          'cron schedule',
        ...
        canonicalUrl="/crontab-generator"
      />
